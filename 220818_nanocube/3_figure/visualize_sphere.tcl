...
topo readlammpsdata coord_sphere.data 
...
mol color Type
mol selection {all and y>75 and not type 1}
mol addrep top
...
# Rendeing options
render Tachyon den "/usr/local/lib/vmd/tachyon_LINUXAMD64" -fullshade -aasamples 12 %s -format TARGA -res 7680 4800 -o %s.tga
