...
topo readlammpsdata nsp_26.6_swp.data
...
proc coord_structure {arg1} {
        ...
        set coordinated_O [atomselect top "type 1 and within 3.0 of index $arg1"]
...
foreach i3 [$fe_group get index] {
	...
	if {[lindex [coord_structure $i3] 1] == 2} {
		# tetrahedral III
        	if {([[atomselect top "index $i3"] get charge] > 1.2)} {
                	[atomselect top "index $i3"] set type 4
        	# tetrahedral II
        	} elseif {[[atomselect top "index $i3"] get charge] < 1.2} {
...
topo writelammpsdata coord_sphere.data full
